...
const int A_MAX = 0x7fff;
const int U_MAX = 32635; //32767 (max 15-bit integer) minus BIAS
const int BIAS = 0x84; //aka 132, or 1000 0100
 ...
 */
static char linear2alaw(short	pcm) 
{
 ...
 *
 */
static short alaw2linear(char alaw)		
{
 ...
 * John Wiley & Sons, pps 98-111 and 472-476.
 */
static char linear2ulaw( short pcm)	/* 2's complement (16-bit range) */
{
	...
	char mulaw = (char)(sign | exponent << 4 | mantissa);
 ...
 */
static short ulaw2linear( char mulaw)
{
	//Flip all the bits
	mulaw = (char)~mulaw;
